 ...
 */
export function createCompiledLumaPayContract(compiledAssetPath = DEFAULT_COMPILED_ASSET_PATH) {
    return CompiledContract.make(LUMAPAY_CONTRACT_NAME, Contract).pipe(CompiledContract.withVacantWitnesses, CompiledContract.withCompiledFileAssets(compiledAssetPath));
}
