    ...
    const sections = [
        {
            ...
            description: "LumaPay currently settles Preprod flows in Midnight NIGHT. Additional private assets can be enabled only after their token contracts and liquidity exist on the target network.",
        ...
        },
        {
            ...
            description: "A powerful SDK for seamless integration. Developers and companies can integrate LumaPay into their platforms as easily as Stripe or Razorpay, bringing private, zero-knowledge payments to their own applications with just a few lines of code.",
        ...
        },
        {
            ...
            description: "Empowering NGOs, creators, and charitable causes. Use open-ended donation campaigns for Midnight NIGHT while preserving payer privacy and merchant-side claim control.",
            ...
            >
                ...
                <motion.div variants={fadeInUp} className="text-center mb-20">
                    ...
                    <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                        LumaPay isn't just a tool; it's a vision for a world where financial privacy is the default, not an option.
                    </p>
                </motion.div>
