        ...
        <div className="space-y-6">
                ...
                <div className="grid gap-0 lg:grid-cols-[220px_minmax(0,1fr)]">
                    ...
                    <div className="space-y-5 p-8">
                        ...
                        <p className="text-base leading-relaxed text-gray-300">
                            The LumaPay Telegram Bot is a merchant-facing companion that sits on top of the main LumaPay web app.
            ...
            <div className="grid gap-5 md:grid-cols-3">
                <MetricCard
                    ...
                    description="Link your Midnight wallet to Telegram via a secure browser flow with signature verification. Once linked, the bot knows your merchant identity for all future commands."
                />
                <MetricCard
                    icon={Zap}
            ...
            <Callout title="Bot Username" tone="blue">
                Find the bot at <span className="font-mono text-blue-300">@LumaPay_private_bot</span> or open{' '}
                <a href="https://t.me/LumaPay_private_bot" target="_blank" rel="noreferrer" className="text-blue-300 underline">
                    t.me/LumaPay_private_bot
                </a>{' '}
