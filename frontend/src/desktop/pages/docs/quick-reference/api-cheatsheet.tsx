    ...
    content: (
        <div className="space-y-6">
            ...
            <Callout title="Base URL" tone="blue">
                Production: <code className="text-orange-300">https://api.lumapay.xyz</code>
                <br />
                All routes are unversioned. No <code className="text-gray-400">/v1</code> prefix. CORS is enabled for LumaPay.app and localhost:5173.
            </Callout>
        </div>
    ),
};
