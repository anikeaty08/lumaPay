        ...
        <div className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <GlassCard className="p-5 border-blue-500/10">
                    ...
                    <div className="space-y-2 text-xs text-gray-400">
                        <div className="flex flex-col gap-0.5 pb-2 border-b border-white/[0.04]">
                            <code className="text-blue-300 font-mono">lumapay.json not found</code>
                        ...
                        <div className="flex flex-col gap-0.5 pb-2 border-b border-white/[0.04]">
                            ...
                            <span>Check lumapay.json has the name, or use inline params</span>
                        </div>
                        <div className="flex flex-col gap-0.5 pb-2 border-b border-white/[0.04]">
                ...
                <GlassCard className="p-5 border-emerald-500/10">
                    ...
                    <div className="space-y-2 text-xs text-gray-400">
                        <div className="flex flex-col gap-0.5 pb-2 border-b border-white/[0.04]">
                            ...
                            <span>Run npx -y @lumapay/mcp with write permissions</span>
                        </div>
                        <div className="flex flex-col gap-0.5 pb-2 border-b border-white/[0.04]">
                            <code className="text-emerald-300 font-mono">Wallet not found</code>
                            <span>Verify LUMAPAY_MAIN_ADDRESS is valid Midnight address</span>
                        </div>
                        <div className="flex flex-col gap-0.5 pb-2 border-b border-white/[0.04]">
            ...
            <Callout title="Debugging Checklist" tone="orange">
                <ol className="list-decimal list-inside space-y-1 text-xs text-gray-400">
                    ...
                    <li>Check salt_to_invoice mapping on Midnight Explorer</li>
                    <li>Confirm token type matches the active Preprod token: NIGHT=0u8</li>
                    <li>Verify expiry_height &gt; current block.height</li>
                    <li>Check status = 0u8 (Open) not 1u8 (Settled)</li>
                    <li>For future quote features: verify signature and expiry before enabling the route</li>
