...
const LumaPayJsonSchema = `{
  "merchant": "midnight1...",           // Merchant Midnight address
...
export const sdkQuickRefSection: DocsSection = {
    ...
    summary: 'Command-line one-liners, SDK method signatures, and the LumaPay config schema. Copy-paste ready for rapid integration.',
    content: (
        <div className="space-y-6">
            <div className="grid gap-4 md:grid-cols-3">
                <GlassCard className="p-5">
                    ...
                    <CodeBlock title="Install" language="bash" code="npm install @lumapay/node@latest" />
                    <div className="mt-3 space-y-1 text-xs text-gray-400">
                        <div className="font-mono text-orange-300">LumaPay.invoices.getAll()</div>
                        <div className="font-mono text-orange-300">LumaPay.invoices.getByName(name)</div>
                        <div className="font-mono text-orange-300">LumaPay.checkout.sessions.create(params)</div>
                        <div className="font-mono text-orange-300">LumaPay.checkout.sessions.retrieve(id)</div>
                        <div className="font-mono text-orange-300">LumaPay.webhooks.verifySignature(body, sig)</div>
                        <div className="font-mono text-orange-300">LumaPay.webhooks.constructEvent(body, sig)</div>
                    </div>
                </GlassCard>
                <GlassCard className="p-5">
                    <div className="flex items-center gap-2 mb-3">
                    ...
                    <CodeBlock title="Install & run" language="bash" code="npx @lumapay/cli@latest sdk onboard" />
                    <div className="mt-3 space-y-1 text-xs text-gray-400">
                ...
                <GlassCard className="p-5">
                    ...
                    <CodeBlock title="Install" language="bash" code="npx -y @lumapay/mcp" />
                    <div className="mt-3 space-y-1 text-xs text-gray-400">
            ...
            <GlassCard className="p-6">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-bold text-white">LumaPay Config Schema</h3>
                </div>
                <CodeBlock title="Schema" language="json" code={LumaPayJsonSchema} />
            </GlassCard>
            ...
            <Callout title="Python SDK" tone="purple">
                <code className="text-purple-300">pip install lumapay-python</code>
                <br />
                Same API surface as Node SDK with snake_case methods:
                <code className="text-gray-400"> LumaPay.invoices.get_all(), checkout.sessions.create(...)</code>
            </Callout>
        </div>
    ),
};
