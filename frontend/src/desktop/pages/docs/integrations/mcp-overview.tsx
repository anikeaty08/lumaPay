...
export const mcpOverviewSection: DocsSection = {
    ...
    title: 'LumaPay MCP Server Capabilities',
    summary:
        'The @lumapay/mcp package provides a secure, local bridge between AI models and your Midnight wallet. It allows models to generate ZK proofs and execute payments without ever exposing your private keys to the cloud.',
    content: (
        <div className="space-y-12">
            ...
            <section className="space-y-4">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                    The LumaPay MCP server runs as a local <strong>stdio</strong> process. It handles encryption, wallet recovery, and ZK proof generation locally, communicating only the necessary transaction results to your AI client or terminal.
                </p>
            </section>
            ...
            <section className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 hover:bg-white/[0.04] transition-all">
                        ...
                        <p className="text-xs leading-relaxed text-gray-400">
                            Allows payments using 16-digit LumaPay cards and Card Secrets without exposing keys.
                        </p>
                    </div>
            ...
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed font-light">
                            When an AI model suggests a payment via <code className="text-white">pay_invoice</code>, the MCP server uses your local private key to generate the required Midnight ZK transitions. This proof is then safely sent to the LumaPay backend for propagation to the Midnight network.
                        </p>
                    </div>
                    <div className="space-y-4">
                ...
                <Callout title="Privacy First" tone="emerald">
                    Only your public address and encrypted session metadata are shared with the backend. Do not provide wallet recovery phrases or raw private keys to AI clients.
                </Callout>
            </section>
        </div>
    ),
