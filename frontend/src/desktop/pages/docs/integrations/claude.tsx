...
export const claudeSection: DocsSection = {
    ...
    title: 'Install LumaPay MCP in Claude Desktop',
    summary: 'Connect LumaPay to Claude Desktop for AI-native payments and invoice management.',
    content: (
        <div className="space-y-12">
            ...
            <section className="space-y-6">
                ...
                <Callout title="Quick Access" tone="blue">
                    Open Claude Desktop â†’ <strong>Settings</strong> â†’ <strong>Developer</strong> â†’ <strong>Edit Config</strong> to open the folder directly.
                </Callout>
            </section>
            ...
            <section className="space-y-6">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                    ...
                    Ensure you replace the placeholders with your actual LumaPay credentials.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <section className="space-y-6">
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed">
                        Look for the ðŸ”Œ <strong>plug icon</strong> in the chat input. Alternatively, check <strong>Settings â†’ Developer</strong> to confirm <code className="text-emerald-400 font-bold">LumaPay</code> is active.
                    </p>
                </section>
            </div>
