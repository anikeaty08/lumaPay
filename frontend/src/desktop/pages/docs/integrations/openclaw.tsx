...
export const openclawSection: DocsSection = {
    ...
    title: 'Adding LumaPay to OpenClaw',
    summary:
        'This guide will walk you through integrating the LumaPay MCP server into your OpenClaw instance. Once configured, you\'ll be able to interact with LumaPay through WhatsApp, Telegram, Slack, Discord, or any other channel connected to OpenClaw.',
    content: (
        <div className="space-y-12">
            <IntegrationBadge
                ...
                description="Connect LumaPay to various messaging platforms via OpenClaw's MCP bridge."
            />
            ...
            <section className="space-y-6">
                ...
                <Callout title="Security Warning" tone="orange">
                    Replace the placeholder values (<code className="text-orange-200">YOUR_NIGHT_ADDRESS</code>, <code className="text-orange-200">YOUR_PRIVATE_KEY</code>, etc.) with your actual credentials. <strong>Never share this file publicly.</strong>
                </Callout>
            ...
            <section className="space-y-4">
                ...
                <p className="text-sm leading-relaxed text-gray-400">
                    With LumaPay active, connect your preferred chat platforms:
                </p>
                <div className="overflow-hidden rounded-xl border border-white/[0.08] bg-white/[0.02]">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm">
