...
export const codexSection: DocsSection = {
    ...
    title: 'Install LumaPay MCP in Codex',
    ...
    content: (
        <div className="space-y-12">
            <IntegrationBadge
                ...
                description="Use the integrated MCP manager to connect LumaPay without editing config files manually."
            />
                        ...
                        <table className="w-full text-left text-[13px] border-collapse">
                            ...
                            <tbody className="divide-y divide-white/[0.04]">
                                <tr>
                                    ...
                                    <td className="px-6 py-4 font-mono text-orange-300/80">LumaPay</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td className="px-6 py-4 space-y-2">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="px-2 py-1 rounded bg-white/5 border border-white/10 font-mono text-gray-400">@lumapay/mcp</div>
                                    ...
                                    <td className="px-6 py-4 space-y-3">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center gap-2">
                                                <code className="text-xs text-gray-500 w-40">LUMAPAY_MAIN_ADDRESS</code>
                                                <span className="text-gray-600">→</span>
                                                <code className="text-xs text-orange-300/80">YOUR_NIGHT_ADDRESS</code>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <code className="text-xs text-gray-500 w-40">LUMAPAY_MAIN_PRIVATE_KEY</code>
                                                <span className="text-gray-600">→</span>
                                                <code className="text-xs text-orange-300/80">YOUR_PRIVATE_KEY</code>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <code className="text-xs text-gray-500 w-40">LUMAPAY_MAIN_PASSWORD</code>
                                                <span className="text-gray-600">→</span>
            ...
            <section className="space-y-6">
                ...
                <p className="text-sm text-gray-400 leading-relaxed max-w-2xl">
                    Back in the MCP servers list, <code className="text-white">LumaPay</code> should appear with a <code className="text-emerald-400 font-bold">green status indicator</code>. 
