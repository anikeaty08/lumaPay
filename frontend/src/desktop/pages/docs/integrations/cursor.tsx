...
export const cursorSection: DocsSection = {
    ...
    title: 'Install LumaPay MCP in Cursor',
        ...
        <div className="space-y-12">
            ...
            <section className="space-y-6">
                ...
                <Callout title="Quick Tip" tone="blue">
                    Open Cursor â†’ <code className="text-blue-300/80 font-mono">Cmd/Ctrl + Shift + P</code> â†’ type <strong>Open User Settings (JSON)</strong> to find your config directory.
                </Callout>
            </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                <section className="space-y-6">
                    ...
                    <p className="text-xs text-gray-400 leading-relaxed">
                        To apply changes, <strong>fully restart</strong> Cursor. On macOS, use <code className="text-white bg-white/5 px-1 py-0.5 rounded italic font-mono">Cmd+Q</code> or use <strong>File â†’ Exit</strong> on Windows.
                    </p>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <p className="text-xs text-gray-400 leading-relaxed">
                        Go to <strong>Settings â†’ Cursor Settings â†’ MCP</strong>. Confirm that <code className="text-emerald-400 font-bold">LumaPay</code> is listed with a green status and tools are visible.
                    </p>
                </section>
            </div>
            ...
            <section className="pt-6 border-t border-white/10">
                ...
                <div className="p-6 rounded-2xl bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.06] transition-all group">
                    <p className="text-gray-300 font-mono text-sm leading-relaxed group-hover:text-white transition-colors">
                        "Check my LumaPay balance in the terminal."
                    </p>
                </div>
            </section>
        </div>
