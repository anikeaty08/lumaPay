...
export const antigravitySection: DocsSection = {
    ...
    title: 'How to Install LumaPay in Google Antigravity',
    summary: 'A step-by-step guide to connecting the LumaPay MCP server to your Google Antigravity IDE.',
    content: (
        <div className="space-y-12">
            <IntegrationBadge
                ...
                description="Connect LumaPay directly to your IDE via the Model Context Protocol."
            />

            {/* Introduction */}
            <section className="space-y-4 text-gray-400 leading-relaxed text-[15px]">
                <p>
                    This guide will walk you through every step needed to connect the LumaPay MCP (Model Context Protocol) server to <strong>Google Antigravity</strong>.
                    Once installed, you can interact with LumaPay directly from your IDE—checking balances, sending payments, and creating invoices using natural language.
                </p>
            </section>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-[13px] border-collapse">
                            ...
                            <tbody className="divide-y divide-white/[0.04]">
                                ...
                                <tr>
                                    <td className="px-6 py-4 font-bold text-gray-300">LumaPay Account</td>
                                    <td className="px-6 py-4 text-gray-400">Midnight address, private key, and password.</td>
                                    <td className="px-6 py-4 text-gray-400">
                                        <a href="https://lumapay.app" target="_blank" rel="noopener noreferrer" className="text-orange-400 underline underline-offset-4 hover:text-orange-300">
                                            Sign up here
                                        </a>
                                    </td>
                                </tr>
            ...
            <section className="space-y-6">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                    ...
                    Replace the placeholders with your actual LumaPay credentials.
                </p>
                    ...
                    <div className="overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02]">
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-[13px] border-collapse">
                                ...
                                <tbody className="divide-y divide-white/[0.04]">
                                    <tr>
                                        <td className="px-6 py-4 font-mono text-orange-300/80">YOUR_NIGHT_ADDRESS</td>
                                        <td className="px-6 py-4 text-gray-400">Your public public Midnight address (Starts with <code className="text-gray-200">midnight1...</code>)</td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 font-mono text-orange-300/80">YOUR_PASSWORD</td>
                                        <td className="px-6 py-4 text-gray-400">The password used to decrypt and authorize your LumaPay wallet.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                ...
                <section className="space-y-6">
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed">
                        ...
                        Confirm that <code className="text-emerald-400 font-bold">LumaPay</code> is listed with a green status indicator.
                    </p>
                </section>
            </div>
            ...
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {[
                        "Show my current LumaPay balance.",
                        "Send 25 NIGHT to mn_...",
                        "Generate a donation invoice for 10 NIGHT.",
