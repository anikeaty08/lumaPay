...
// Exported from @lumapay/node

export interface LumaPayInvoice {
    ...
    /** The token ticker. Preprod active value is NIGHT. */
    currency:  string;              
 ...
 * It acts as a wrapper around the lumapay.json manifest.
 */

// 1. Precise Lookup
const plan = LumaPay.invoices.getByName('premium-tier');

// 2. Collection Filters
const subscriptions = LumaPay.invoices.getByType('multipay');

// 3. Batch Retrieval
const all = LumaPay.invoices.getAll();

// ERROR HANDLING:
// If "premium-tier" is missing, getByName() throws an error:
// "Invoice 'premium-tier' not found in lumapay.json. Available: intro, middle, elite"
...
LumaPay.invoices.getAll().forEach(invoice => {
...
export const invoiceHelpersSection: DocsSection = {
    ...
    summary:
        'The invoices namespace provides high-performance, synchronous utilities for interacting with your local lumapay.json manifest. These methods are designed to simplify route handling and invoice lookups.',
    content: (
        <div className="space-y-6">
            <div className="grid gap-5 md:grid-cols-4">
                ...
                <MetricCard
                    icon={RefreshCw}
                    title="Dynamic Sync"
                    description="Automatically refreshes based on the content of lumapay.json on server startup."
                />
                <MetricCard
                    icon={AlertCircle}
                    title="Fail-Fast"
            ...
            <GlassCard className="p-6">
                ...
                <p className="mb-4 text-sm text-gray-400">
                    Each <code className="text-white/80">LumaPayInvoice</code> object represents a unique, on-chain commitment that the merchant has pre-generated.
                </p>
            ...
            <GlassCard className="p-6">
                ...
                <p className="mb-4 text-sm text-gray-400">
                    The <code className="text-white/80">LumaPay.invoices</code> namespace maps your developer-friendly names to Midnight blockchain identifiers.
                </p>
            ...
            <GlassCard className="p-6">
                ...
                <p className="mb-4 text-sm text-gray-400">
                    For merchants with dynamic product lists, the best practice is to iterate the manifest during application startup. This turns your <code className="text-white/80">lumapay.json</code> into a configuration-driven routing table.
                </p>
