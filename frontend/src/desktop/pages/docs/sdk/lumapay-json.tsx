...
const lumapayJsonStructureExample = `// Annotated lumapay.json Structure

{
  /**
   * The public Midnight address (midnight1...) of the merchant.
  ...
  "invoices": [
    {
      /** Unique alias used in the Node SDK lumapay_invoice_name parameter */
      "name": "pro-plan",
 ...
 * 
 * The 'hash' field in lumapay.json is derived using the BHP256 
 * Pedersen Hash algorithm on the Midnight blockchain.
 * 
...
export const lumapayJsonSection: DocsSection = {
    id: 'sdk-lumapay-json',
    group: 'Config',
    label: 'lumapay.json',
    eyebrow: 'SDK',
    title: 'lumapay.json — The Local Merchant Manifest',
    summary:
        'The lumapay.json file acts as a local "Lookup Table" for your on-chain invoices. It bridge the gap between human-readable names and the low-level BHP256 hashes required by the Midnight network.',
    content: (
        <div className="space-y-6">
            <div className="grid gap-5 md:grid-cols-4">
                ...
                <MetricCard
                    ...
                    description="The manifest is generated only after the CLI confirms the invoice exists in the Midnight salt_to_invoice mapping."
                />
                <MetricCard
                    icon={Layers}
                    title="Context Aware"
            ...
            <GlassCard className="p-6">
                ...
                <p className="mb-4 text-sm text-gray-400">
                    The <code className="text-white/80">lumapay.json</code> file is a standard JSON manifest. It should be kept in your server-side repository and loaded by the SDK at startup.
                </p>
                    <CodeBlock title="lumapay.json structure" language="json" code={lumapayJsonStructureExample} />
            </GlassCard>
            ...
            <GlassCard className="p-6 border-emerald-500/20 bg-emerald-500/5">
                ...
                <p className="mb-4 text-sm text-gray-400 leading-relaxed">
                    Unlike standard web hashes (MD5, SHA256), LumaPay uses <b>BHP256 (Pedersen Hash)</b>. This algorithm is optimized for Zero-Knowledge circuits, allowing the buyer to prove they paid exactly the amount specified in the manifest without revealing the manifest content to the entire network.
                </p>
            ...
            <GlassCard className="p-6">
                ...
                <div className="space-y-4 text-sm text-gray-400">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <p><b>project root:</b> If <code className="text-white/80">projectRoot</code> is provided, the SDK searches for <code className="text-white/80">lumapay.json</code> in that specific folder.</p>
                    </div>
                    <div className="flex items-start gap-3">
            ...
            <Callout title="Public Data, Private Secrets" tone="blue">
                Even though <code className="text-white/80">lumapay.json</code> contains hashes and salts, it is perfectly safe to keep public. These values are committed to the public Midnight blockchain. The ONLY secret you must protect is your <code className="text-blue-200">LUMAPAY_SECRET_KEY</code> and your merchant wallet's private key.
            </Callout>
        </div>
    ),
};
