...
const backendBaseExample = `// LumaPay Backend API
// Base URL: https://api.lumapay.xyz
...
export const apiOverviewSection: DocsSection = {
    ...
    summary: 'Complete reference for the LumaPay backend REST API. Covers all endpoints across invoices, checkout, DPS (Delegated Proving Service), Oracle conversion, merchants, users, MCP, and scanner proxies.',
    content: (
        <div className="space-y-6">
            ...
            <Callout title="Production URL" tone="blue">
                The production backend is hosted at <code className="rounded bg-white/10 px-1.5 py-0.5">https://api.lumapay.xyz</code>.
