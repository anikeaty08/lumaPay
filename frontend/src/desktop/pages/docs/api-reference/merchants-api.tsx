...
// Body: { name, midnight_address, webhook_url? }
...
// Body: { midnight_address, password_hash?, metadata? }
...
{
  "name": "Dhruv's Store",
  "midnight_address": "midnight1yu926k0jqqzfv06js4jlsxnf2ejah47rfqsxmwfx6tvuxxgvrqpqdlq5y0",
  "webhook_url": "https://mystore.com/api/LumaPay-webhook"
}
