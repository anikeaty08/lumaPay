...
// LumaPay backend sponsors the fee
...
// LumaPay relayer wallet submits on-chain create_invoice transaction`;
    ...
    content: (
        <div className="space-y-6">
            ...
            <Callout title="The Relayer Flow" tone="blue">
                The relayer invoice creation is the core of the "sponsored setup" model. LumaPay's relayer wallet submits
                the <code className="rounded bg-white/10 px-1.5 py-0.5">create_invoice</code> transaction on-chain and pays the Midnight gas fee.
                ...
                ever needing to hold Midnight NIGHT for invoice setup.
            </Callout>
            ...
            <Callout title="sponsor-sweep" tone="orange">
                ...
                burner wallet sweeps, gift card redemptions, and direct gift card payment flows. LumaPay's backend sponsors
                the execution fee for these supported actions so the burner/card holder doesn't need to maintain NIGHT.
            </Callout>
        </div>
    ),
};
