 ...
 * LumaPay uses a multi-field fragmentation strategy.
 * 
 ...
 * only the owner of the main Midnight address can even view the 
        ...
        <div className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <GlassCard className="p-6">
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed">
                        LumaPay implements a decentralized backup system for burner wallets. By splitting encrypted private keys across multiple Midnight fields and storing them in private records, users can "recover" their funds from any device by just logging in with their main Midnight wallet.
                    </p>
                </GlassCard>
            </div>
            ...
            <GlassCard className="overflow-hidden p-0">
                ...
                <div className="px-6 py-5">
                    <p className="mb-4 text-sm text-gray-400">
                        The recovery system utilizes a 10-part field splitting technique to accommodate Midnight's 256-bit field constraints while storing a full encrypted private key.
                    </p>
            ...
            <GlassCard className="p-6">
                ...
                <div className="grid gap-3 md:grid-cols-4">
                    {[
                        { step: 'Lookup', desc: 'Scan the Midnight ledger for BurnerWalletRecords owned by the main address.' },
