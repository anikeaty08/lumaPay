...
/**
 * LIFECYCLE:
 * 1. MINTED: When npx @lumapay/cli onboard is run.
...
export const recordsSection: DocsSection = {
    ...
    summary:
        'Records are the fundamental unit of private state in Midnight. In LumaPay, records are used to store invoices, payment receipts, and encrypted wallet backups with absolute privacy.',
    content: (
        <div className="space-y-6">
            ...
            <GlassCard className="p-6">
                ...
                <p className="mb-4 text-sm text-gray-400 leading-relaxed">
                    A unique challenge in ZK contracts is storing large data (like a 256-bit private key) inside 254-bit field elements. LumaPay solves this by <b>sharding</b> data across multiple fields within a single record.
                </p>
            ...
            <Callout title="Owner-Only Access" tone="blue">
                Even our administrators and relayers CANNOT read the contents of your <code className="text-white/80">Invoice</code> or <code className="text-white/80">Receipt</code> records. They are encrypted at the protocol level using Midnight's ECIES primitive, ensuring that your business sales data remains strictly between you and your customers.
            </Callout>
        </div>
    ),
};
