 ...
 * 
 * By separating state into two mappings, LumaPay achieves:
...
export const mappingsSection: DocsSection = {
    ...
    summary:
        'Mappings represent the persistent, public state of the LumaPay protocol. They act as the "Global Key-Value Store" where ZK-Proof commitments are recorded and verified by the Midnight network.',
    content: (
        <div className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
                <GlassCard className="p-6">
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed">
                        Midnight mappings are public. However, LumaPay obfuscates the relationship between a payer and a product by using <b>Salted Hashes</b> as the primary keys. An external observer may see a change in mapping state, but cannot determine the merchant or amount without the corresponding private salt.
                    </p>
                </GlassCard>
                <GlassCard className="p-6">
                    <div className="mb-4 flex items-center gap-2">
            ...
            <GlassCard className="overflow-hidden p-0">
                <div className="border-b border-white/[0.08] bg-white/[0.02] px-6 py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-orange-300">Program: zk_pay.midnight</p>
                    </div>
            ...
            <GlassCard className="overflow-hidden p-0">
                <div className="border-b border-white/[0.08] bg-white/[0.02] px-6 py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-emerald-300">Program: zk_pay.midnight</p>
                    </div>
            ...
            <Callout title="Midnight Explorer Integration" tone="blue">
                You can manually inspect these mappings by searching for the <code className="text-blue-200">zk_pay.midnight</code> program on any Midnight block explorer. Look for the "Mappings" tab to see the live size and state updates of the protocol registry.
            </Callout>
        </div>
    ),
};
