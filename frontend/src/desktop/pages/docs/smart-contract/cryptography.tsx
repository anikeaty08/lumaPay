 ...
 * 
 * Unlike SHA3 or Keccak, LumaPay uses the BHP256 Pedersen Hash 
 ...
 * LumaPay uses a 'hiding and binding' commitment.
 * 
 * Key Variables:
...
export const cryptographySection: DocsSection = {
    ...
    summary:
        'LumaPay relies on the BHP256 (Pedersen Hash) algorithm for all on-chain privacy guarantees. This section explains the mathematical choices behind the protocol hashing and commitment schemes.',
    content: (
        <div className="space-y-6">
            ...
            <GlassCard className="p-6">
                ...
                <p className="mb-4 text-sm text-gray-400 leading-relaxed">
                    LumaPay uses <b>Homomorphic Hashing</b>. By hashing each component (Merchant, Amount, Salt) individually and then adding the results, we create a composite hash. This is more circuit-efficient than hashing a concatenated string of inputs.
                </p>
            ...
            <GlassCard className="p-6 border-blue-500/20 bg-blue-500/5">
                ...
                <p className="mb-4 text-sm text-gray-400 leading-relaxed">
                    A receipt in LumaPay is a <b>Pedersen Commitment</b>. It binds a payer-generated secret to the specific invoice salt. This creates a "dual-key" verification system where both parties can cryptographically prove the transaction occurred without revealing their addresses to the network.
                </p>
            ...
            <GlassCard className="p-6">
                ...
                <div className="space-y-4 text-sm text-gray-400">
                    <div className="relative pl-6">
                        ...
                        <p><b>Constraint Cost:</b> SHA-256 requires thousands of boolean constraints, making it extremely slow for ZK proofs on mobile devices. BHP256 is native to Midnight and executes in milliseconds.</p>
                    </div>
                    <div className="relative pl-6">
            ...
            <Callout title="Scalar Conversion" tone="blue">
                In Midnight, <code className="text-white/80">commit_to_field</code> requires the randomness to be a <code className="text-emerald-300">scalar</code>. LumaPay automatically handles this by converting the 254-bit salt using the <code className="text-white/80">BHP256::hash_to_scalar()</code> helper before committing.
            </Callout>
        </div>
    ),
};
