...
export const docsTabs: DocsTab[] = [
    {
        ...
        icon: Rocket,
        blurb: 'What LumaPay is, what problem it solves, and how to get live quickly.',
    },
    {
        id: 'smart-contract',
    ...
    },
    {
        ...
        label: 'SDK',
        icon: Package,
        blurb: 'Node.js SDK, Python SDK, CLI, lumapay.json, checkout sessions, webhooks, and the testing-website integration flow.',
    },
    {
        id: 'api-reference',
        label: 'API Reference',
    ...
    },
    {
        ...
        label: 'Architecture',
        icon: Blocks,
        blurb: 'How the UI, backend, relayer, MCP, smart contracts, and Midnight network fit together.',
    },
    {
        id: 'quick-reference',
        label: 'Quick Ref',
