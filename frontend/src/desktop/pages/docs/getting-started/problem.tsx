...
export const problemSection: DocsSection = {
    ...
    label: 'Problem',
    eyebrow: 'Problem',
    title: 'What LumaPay is trying to fix',
    summary:
        'Moving value is easy to describe and hard to productize well. LumaPay is solving for privacy leakage in payments, poor merchant ergonomics on ZK chains, broken checkout-to-fulfillment workflows, and the emerging challenge of letting AI clients participate in payment operations safely.',
    content: (
        <div className="space-y-6">
            <div className="grid gap-5 lg:grid-cols-2">
                ...
                <GlassCard className="p-6">
                    ...
                    <p className="text-sm leading-relaxed text-gray-400">
                        ...
                        "I understand Midnight's cryptographic primitives" is enormous. LumaPay packages those concerns into developer
                ...
                <GlassCard className="p-6">
                    ...
                    <p className="text-sm leading-relaxed text-gray-400">
                        ...
                        stop at "here's a transaction hash, good luck." LumaPay treats backend verification, webhook delivery,
                ...
                <GlassCard className="p-6">
                    ...
                    <p className="text-sm leading-relaxed text-gray-400">
                        ...
                        merchant accounts — but they should not directly own raw wallet secrets. Sending your Midnight private key
                        in a chat prompt is a catastrophic security practice. LumaPay MCP creates a safer local boundary where
            ...
            <Callout title="Why this matters" tone="orange">
                LumaPay is trying to give developers something close to a modern payment platform experience (like Stripe or
                Lemon Squeezy), but for private payments on Midnight: cleaner integration, less operational glue code, much
