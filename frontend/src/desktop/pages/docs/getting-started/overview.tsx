        ...
        <div className="space-y-6">
            <GlassCard className="overflow-hidden border-white/[0.08] bg-white/[0.02] p-0">
                <div className="grid gap-0 lg:grid-cols-[220px_minmax(0,1fr)]">
                    <div className="flex items-center justify-center border-b border-white/[0.08] bg-black/30 p-8 lg:border-b-0 lg:border-r">
                        <img src="/assets/lumapay-mark.png" alt="LumaPay" className="h-28 w-28 object-contain" />
                    </div>
                    <div className="space-y-5 p-8">
                        <p className="text-[11px] font-black uppercase tracking-[0.22em] text-orange-300">Privacy-First Payments on Midnight</p>
                        <p className="text-2xl font-bold leading-snug text-white">
                            Private checkout infrastructure for merchants, apps, and AI-native products.
                        </p>
                        <p className="text-base leading-relaxed text-gray-300">
                            LumaPay lets merchants create invoices and accept payments without exposing the sensitive parts of
            ...
            <div className="grid gap-5 md:grid-cols-3">
                ...
                <MetricCard
                    ...
                    description="Merchants integrate through backend routes, hosted checkout, SDK calls, lumapay.json manifests, and webhooks instead of piecing together low-level chain logic themselves."
                />
                <MetricCard
                    icon={Bot}
                    title="Agent ready"
                    description="LumaPay MCP exposes invoice and payment actions to AI clients while keeping the private key local to the MCP process rather than in the model context."
                />
            </div>
            ...
            <div className="grid gap-5 lg:grid-cols-2">
                <GlassCard className="p-6">
                    ...
                    <div className="space-y-4 text-sm leading-relaxed text-gray-400">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p><span className="font-semibold text-white">@lumapay/node</span> & <span className="font-semibold text-white">lumapay-python</span></p>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p><span className="font-semibold text-white">@lumapay/cli</span></p>
                                <p className="text-xs text-gray-500 mt-0.5">Interactive onboarding wizard that generates salts, creates invoices via the relayer, and writes lumapay.json to your project.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            <Bot className="mt-0.5 h-4 w-4 shrink-0 text-orange-300" />
                            <div>
                                <p><span className="font-semibold text-white">@lumapay/mcp</span></p>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">zk_pay_proofs_privacy_v29.midnight (core invoice/payment) and zk_pay_proofs_privacy_wallet_v6.midnight (burner backup, card profiles, gift cards, oracle).</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">Buyer-side payment completion, NIGHT settlement (multi-token routing and Oracle conversion land once cross-token quotes are re-enabled), and post-payment verification.</p>
                            </div>
                        </div>
                    </div>
                </GlassCard>
                ...
                <Callout title="Mental model" tone="blue">
                    Think of LumaPay as a merchant payment operating layer. The contract enforces invoice and payment rules,
                    the backend and SDK make integration usable for normal apps, the hosted checkout handles buyer UX, and
                    MCP extends the same system into conversational clients — all backed by Midnight's zero-knowledge cryptography.
                </Callout>
            </div>

            <GlassCard className="p-6">
                <h3 className="mb-5 text-xl font-bold text-white">The LumaPay Stack</h3>
                    ...
                    <table className="w-full text-sm">
                        ...
                        <tbody className="text-gray-300">
                            <tr className="border-b border-white/[0.04]">
                                ...
                                <td className="px-4 py-3 text-sm text-gray-400">Desktop &amp; mobile responsive app with glassmorphism UI, Framer Motion animations, Midnight wallet adapter, and hosted checkout.</td>
                            </tr>
                            <tr className="border-b border-white/[0.04]">
                            ...
                            <tr className="border-b border-white/[0.04]">
                                ...
                                <td className="px-4 py-3 font-mono text-xs text-orange-300">@lumapay/node + lumapay-python + @lumapay/cli</td>
                            ...
                            <tr>
                                ...
                                <td className="px-4 py-3 font-mono text-xs text-orange-300">@lumapay/mcp + OpenClaw + Telegram Bot</td>
                                <td className="px-4 py-3 text-sm text-gray-400">MCP server for AI clients, Telegram merchant controls, LumaBot dashboard assistant.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <Callout title="Quick Start" tone="emerald">
                The fastest way to integrate LumaPay is backend-first: install the Node SDK, set your secret key,
