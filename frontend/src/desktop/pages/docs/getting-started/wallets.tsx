...
const walletOperationsExample = `// The LumaPay platform uses two wallet programs:
// 1. zk_pay_proofs_privacy_v29.midnight — Core invoice/payment
// 2. zk_pay_proofs_privacy_wallet_v6.midnight — Wallet artifacts & oracle
...
export const walletsSection: DocsSection = {
    ...
    title: 'Wallets and identity on LumaPay',
    summary:
        'LumaPay supports two distinct wallet identities: a Main Wallet connected via the Shield browser extension, and an optional Burner Wallet for anonymous payment identities. Cards extend this with PIN + secret-based checkout flows that don\'t require a wallet at all.',
    content: (
        <div className="space-y-6">
            <div className="grid gap-5 md:grid-cols-3">
                <MetricCard
                    ...
                    description="Your primary Midnight wallet connected via Shield browser extension. Used for merchant registration, invoice creation, receiving settlements, and dashboard analytics."
                />
                <MetricCard
                    icon={Wallet}
                    title="Burner Wallet"
                    description="An ephemeral Midnight keypair generated inside the platform. Sends payments without linking to your main identity. Can be backed up on-chain as encrypted private records."
                />
                <MetricCard
                    icon={Lock}
                    title="LumaPay Card"
            ...
            <GlassCard className="p-6">
                ...
                <div className="space-y-4 text-sm leading-relaxed text-gray-400">
                    <p>
                        The Main Wallet is your primary Midnight address, managed through the <span className="font-semibold text-white">Shield browser extension</span> (available on Play Store for mobile).
            ...
            <GlassCard className="p-6">
                ...
                <div className="space-y-4 text-sm leading-relaxed text-gray-400">
                    <p>
                        The Burner Wallet is a <span className="font-semibold text-white">disposable keypair</span> generated directly inside the LumaPay platform.
                        Its purpose is to give payers a payment identity that is completely disconnected from their main Midnight address.
                    </p>
                    <div className="grid gap-3 md:grid-cols-2">
                        <div className="rounded-lg border border-white/[0.08] bg-white/[0.02] p-3">
                            <p className="text-xs leading-relaxed">
                    ...
                    <p className="mt-3 text-orange-300/80 text-xs font-semibold uppercase tracking-widest">
                        The burner wallet is recoverable from an on-chain record if lost. It is not a "throwaway" — LumaPay gives it proper backup semantics.
                    </p>
                </div>
            </GlassCard>

            <GlassCard className="p-6">
                <h3 className="mb-4 text-xl font-bold text-white">The LumaPay Card</h3>
                <div className="space-y-3 text-sm leading-relaxed text-gray-400">
                    <p>
                        The <span className="font-semibold text-white">LumaPay Card</span> is a wallet-free checkout flow that lets buyers pay using just a Card Number, PIN, and Card Secret — no browser extension or Midnight wallet required.
                    </p>
            ...
            <GlassCard className="p-6">
                ...
                <p className="mb-3 text-sm leading-relaxed text-gray-400">
                    Every Midnight transaction requires a fee in NIGHT. LumaPay exposes two fee modes toggleable from the navigation header:
                </p>
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-lg border border-white/[0.08] bg-white/[0.02] p-4">
                        <p className="mb-1 text-sm font-bold text-white">Estimation Mode</p>
                        <p className="text-xs leading-relaxed text-gray-400">
                            Dynamically queries the Midnight network for current fee conditions and applies a safety buffer.
                    ...
                    <div className="rounded-lg border border-white/[0.08] bg-white/[0.02] p-4">
                        ...
                        <p className="text-xs leading-relaxed text-gray-400">
                            Uses a hardcoded constant of <code className="rounded bg-white/5 px-1 py-0.5 text-orange-300">0.02 NIGHT</code> per transaction.
            ...
            <Callout title="Never expose private keys to the model" tone="orange">
                When using LumaPay MCP with AI clients, configure <code className="rounded bg-white/10 px-1.5 py-0.5">LUMAPAY_MAIN_PRIVATE_KEY</code> as
