...
const backendEnvExample = `LUMAPAY_SECRET_KEY=your_api_key_here
LUMAPAY_BASE_URL=https://api.lumapay.xyz
        ...
        <div className="space-y-8">
            <div className="grid gap-5 md:grid-cols-4">
                ...
                <MetricCard
                    ...
                    description="Set the LumaPay secret key and initialize the client with your backend root so lumapay.json can be resolved consistently across environments."
                />
                <MetricCard
                    icon={CheckCircle}
            ...
            <div className="grid gap-5 xl:grid-cols-4">
                ...
                <CodeBlock title="Install Python SDK" language="bash" code="pip install lumapay-python" />
            </div>
            ...
            <div className="grid gap-5 lg:grid-cols-2">
                <Callout title="When to use the CLI" tone="emerald">
                    Use <code className="rounded bg-white/10 px-1.5 py-0.5">npx @lumapay/cli@latest sdk onboard</code> when you
                    want reusable, named invoices such as subscription plans, donation campaigns, or a stable catalog of merchant
                    payment definitions. It writes <code className="rounded bg-white/10 px-1.5 py-0.5">lumapay.json</code> into
                    your backend project and uses the relayer for on-chain invoice setup.
                </Callout>
                <Callout title="When to use MCP" tone="orange">
                    Add LumaPay MCP when the operator experience itself matters — for example when a merchant or agent wants to
            ...
            <Callout title="Security boundary" tone="orange">
                ...
                treat webhook verification as mandatory before fulfillment. LumaPay gives you tools for all three boundaries,
