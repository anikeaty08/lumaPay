...
//
// This is NOT an SDK feature — it is a UI flow in the LumaPay platform.
...
const explorerExample = `// The LumaPay Explorer (Transaction Explorer) lets you
// look up Midnight transactions by their on-chain transaction ID.
//
// Access: /explorer route on the platform
//
// What you can look up:
//   - Midnight transaction status (confirmed, pending, failed)
...
//   into the Explorer to confirm it on the public Midnight ledger.`;

const giftCardExample = `// Gift Cards on LumaPay are on-chain records created by
// the wallet program (zk_pay_proofs_privacy_wallet_v3.midnight).
//
// How gift cards work:
...
//   3. Recipients can hold these records in their Midnight wallet.
...
// https://lumapay.app/pay?merchant={address}&salt={salt}
//
// This link can be:
//   - Shared as text
...
export const platformFeaturesSection: DocsSection = {
    ...
    title: 'LumaPay platform features beyond checkout',
    summary:
        'LumaPay is more than a checkout SDK. The platform includes batch payment tooling, a transaction explorer, gift card infrastructure, Profile QR payment links, and realtime merchant dashboards — all built on the same private Midnight foundation.',
    content: (
        <div className="space-y-6">
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                ...
                <MetricCard
                    ...
                    description="Look up any Midnight transaction by ID. Verify on-chain confirmations for settled payments without leaving the platform."
                />
                <MetricCard
                    icon={Activity}
                    title="Gift Cards"
                    description="Mint private on-chain gift card records through the wallet program. Recipients hold them in their Midnight wallet and can redeem them."
                />
                <MetricCard
                    icon={BarChart2}
            ...
            <GlassCard className="p-6">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-3">
                    <div className="rounded-lg border border-white/[0.08] bg-white/[0.02] p-4">
                        ...
                        <p className="text-xs leading-relaxed text-gray-400">NIGHT on Preprod. Each recipient payment uses the native Midnight wallet transfer path.</p>
                    </div>
                    <div className="rounded-lg border border-white/[0.08] bg-white/[0.02] p-4">
                    ...
                    <div className="rounded-lg border border-white/[0.08] bg-white/[0.02] p-4">
                        ...
                        <p className="text-xs leading-relaxed text-gray-400">Available at the BatchPay page in the nav. Requires a connected Midnight wallet.</p>
                    </div>
                </div>
            </GlassCard>
            ...
            <GlassCard className="p-6">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    {[
                        { metric: 'Total Volume', desc: 'Sum of all SETTLED session amounts for your merchant address. Denominated in NIGHT.' },
                ...
                <p className="mt-4 text-xs leading-relaxed text-gray-500">
                    Analytics are fetched from the LumaPay backend and are scoped to your connected main wallet address. Connect the Shield extension to view your merchant data.
                </p>
            </GlassCard>
        </div>
    ),
