...
export const dataFlowsSection: DocsSection = {
    ...
    summary:
        'LumaPay architecture is divided into four distinct "Planes". Each plane handles a specific type of data with its own latency, security, and persistence requirements.',
    content: (
        <div className="space-y-6">
            <div className="grid gap-5 lg:grid-cols-2">
                <GlassCard className="p-6">
                    ...
                    <p className="text-sm leading-relaxed text-gray-400">
                        Defines the environment and business rules <b>before</b> any transaction occurs. This includes the <code className="text-white/80">lumapay.json</code> manifest, merchant dashboard settings, and environment variables like <code className="text-white/80">LUMAPAY_SECRET_KEY</code>.
                    </p>
                ...
                <GlassCard className="p-6">
                    ...
                    <p className="text-sm leading-relaxed text-gray-400">
                        The asynchronous feedback loop. Webhook notifications and polling services monitor the Midnight ledger for "Settled" events and trigger fulfillment logic in the merchant's backend.
                    </p>
                    <div className="mt-4 flex items-center gap-2 text-[10px] text-gray-600 font-mono">
                        <span>ASYNC</span>
                        <ArrowRight className="h-3 w-3" />
            ...
            <GlassCard className="p-6">
                ...
                <div className="relative border-l-2 border-white/10 ml-4 py-2 space-y-8">
                    {[
                        { plane: 'Config', action: 'Merchant runs CLI onboard', result: 'Invoice hash committed to mapping & lumapay.json.' },
