...
export const architectureDiagramSection: DocsSection = {
    ...
    title: 'LumaPay System Architecture Diagram',
    summary:
        'A visual map of the LumaPay stack showing how the frontend, backend, integrations, and on-chain protocol layers fit together.',
    content: (
        <div className="space-y-8">
            <DiagramFigure
                src="/assets/lumapay-system-architecture.png"
                alt="LumaPay system architecture diagram"
                caption="High-level layout of LumaPay components and how requests move between user interfaces, backend orchestration, integrations, and Midnight settlement."
            />
            ...
            <section className="space-y-6">
                ...
                <p className="text-sm text-gray-400 leading-relaxed">
                    LumaPay is organized into five independent layers. Each layer communicates with adjacent layers through well-defined APIs, ensuring that a failure in one layer cannot cascade into others.
                </p>
                ...
                <div className="grid gap-5 lg:grid-cols-2">
                    ...
                    <GlassCard className="p-6">
                        ...
                        <p className="text-sm leading-relaxed text-gray-400 mb-4">
                            SDKs and protocol bridges that connect external systems to LumaPay. The Node.js SDK wraps REST calls, while the MCP server provides a local stdio bridge for AI assistants.
                        </p>
                        <div className="flex flex-wrap gap-2">
                            <span className="px-2 py-0.5 rounded bg-white/[0.03] text-[10px] text-gray-500 font-mono">@lumapay/node</span>
                            <span className="px-2 py-0.5 rounded bg-white/[0.03] text-[10px] text-gray-500 font-mono">@lumapay/mcp</span>
                            <span className="px-2 py-0.5 rounded bg-white/[0.03] text-[10px] text-gray-500 font-mono">@lumapay/cli</span>
                            <span className="px-2 py-0.5 rounded bg-white/[0.03] text-[10px] text-gray-500 font-mono">lumapay.json</span>
                        </div>
                    </GlassCard>
                    ...
                    <GlassCard className="p-6">
                        ...
                        <p className="text-sm leading-relaxed text-gray-400 mb-4">
                            The Midnight Leo programs that enforce payment rules on-chain. Two programs handle invoices, settlements, wallet helpers, and Oracle price anchoring. All state transitions are ZK-proven and immutable.
                        </p>
                        <div className="flex flex-wrap gap-2">
                            <span className="px-2 py-0.5 rounded bg-white/[0.03] text-[10px] text-gray-500 font-mono">zk_pay_proofs_privacy_v29.midnight</span>
                            <span className="px-2 py-0.5 rounded bg-white/[0.03] text-[10px] text-gray-500 font-mono">zk_pay_proofs_privacy_wallet_v6.midnight</span>
                    ...
                    <GlassCard className="p-6">
                        ...
                        <p className="text-sm leading-relaxed text-gray-400 mb-4">
                            The cryptographic foundation: BHP256 commitment hashes, random field salts, AES-256-GCM encrypted local storage, and Midnight account identity (view key / private key / address triple). No seed phrase ever leaves the local device.
                        </p>
                        <div className="flex flex-wrap gap-2">
                            ...
                            <span className="px-2 py-0.5 rounded bg-white/[0.03] text-[10px] text-gray-500 font-mono">midnight-wallet-adaptor</span>
                        </div>
                    </GlassCard>
                </div>
            </section>
            ...
            <section className="space-y-6">
                ...
                <p className="text-sm text-gray-400 leading-relaxed">
                    A single invoice payment crosses all six layers in roughly 300–800 ms (excluding Midnight block finality). Here is the exact path a request takes from buyer click to on-chain settlement.
                </p>
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            },
                            {
                                ...
                                detail: 'The relayer node assembles the transaction, pays the Midnight network fee from its own balance, and submits the proof to the mempool.',
                                icon: Network,
                            ...
                            },
                            {
                                step: '5',
                                layer: 'Core Protocol',
                                title: 'Midnight ledger validates ZK proof',
            ...
            <Callout title="Design Principle" tone="emerald">
                Every layer is <strong>stateless</strong> with respect to the next. The Presentation layer never stores merchant secrets; the Relayer never sees invoice salts; the Protocol layer never reveals payer identity. This compartmentalization is what makes LumaPay robust against single-point failures.
            </Callout>
        </div>
    ),
};
