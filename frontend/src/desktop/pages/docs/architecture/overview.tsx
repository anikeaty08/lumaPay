...
export const architectureOverviewSection: DocsSection = {
    ...
    summary:
        'LumaPay is built on a modular four-layer architecture that separates sensitive ZK-proof generation from high-performance orchestration and on-chain settlement.',
    content: (
        <div className="space-y-6">
                    ...
                    <div className="md:col-span-2 space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex flex-wrap gap-2">
                                <span className="px-2 py-0.5 rounded-md bg-orange-500/5 border border-orange-500/10 text-[10px] font-mono text-orange-300/70 uppercase tracking-wider">zk_pay_proofs_privacy_v29.midnight</span>
                            </div>
                            <p className="text-xs text-gray-500">Core payment program: invoice creation, payments, settlement</p>
                            <div className="flex flex-wrap gap-2">
                                <span className="px-2 py-0.5 rounded-md bg-orange-500/5 border border-orange-500/10 text-[10px] font-mono text-orange-300/70 uppercase tracking-wider">zk_pay_proofs_privacy_wallet_v6.midnight</span>
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <GlassCard className="p-6 border-white/[0.05] bg-white/[0.01] border-l-2 border-l-orange-500/10" hoverEffect={false}>
                        ...
                        <p className="text-xs text-gray-500 leading-relaxed font-light">
                            Node.js nodes managing session lifecycles, gas sponsorship for gasless UX, and proof propagation to the Midnight L1 network.
                        </p>
                        ...
                        <div className="flex gap-4 group">
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex flex-wrap gap-1.5">
                                    <span className="px-1.5 py-0.5 rounded bg-white/[0.03] text-[9px] text-gray-500">@lumapay/node</span>
            ...
            <div className="pt-8 flex items-center justify-between border-t border-white/[0.05]">
                <p className="text-xs text-gray-500 max-w-sm leading-relaxed">
                    By decoupling proof generation from network propagation, LumaPay maintains Web2 performance with ZK privacy.
                </p>
