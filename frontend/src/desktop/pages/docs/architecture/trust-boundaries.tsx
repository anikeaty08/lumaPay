...
export const trustBoundariesSection: DocsSection = {
    ...
    summary:
        'LumaPay is built on a "Least Privilege" architecture. Each layer of the stack—from the local CLI to the on-chain contract—operates within a strictly defined boundary to minimize the blast radius of any potential compromise.',
    content: (
        <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <GlassCard className="p-6">
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed mb-4">
                        While the Midnight blockchain is the ultimate source of truth, <b>99% of LumaPay data is never stored publicly</b>. We use on-chain mappings only as "Commitment Anchors".
                    </p>
            ...
            <Callout title="The Relayer Rule" tone="orange">
                Merchant secret keys belong in the backend only. The LumaPay SDK is designed so that the client (buyer's browser) never receives merchant credentials or sees the original salt used for the invoice commitment.
            </Callout>
        </div>
    ),
};
