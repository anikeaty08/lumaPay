                ...
                <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                    <GlassCard className="p-5">
                        ...
                        <p className="text-xs text-gray-400 leading-relaxed">
                            Merchant runs <code className="text-orange-300/80">LumaPay onboard</code> via CLI. This generates <code className="text-orange-300/80">lumapay.json</code>, registers the merchant account, and sets up the wallet adaptor.
                        </p>
                    </GlassCard>
                    ...
                    <GlassCard className="p-5">
                        ...
                        <p className="text-xs text-gray-400 leading-relaxed">
                            Backend calls <code className="text-orange-300/80">POST /api/v1/invoices</code> with amount, token, and expiry. A BHP256 hash is computed and committed to the Midnight mapping via the relayer.
                        </p>
                    </GlassCard>
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            },
                            {
                                ...
                                detail: 'Buyer connects their main Midnight wallet (Puzzle, Fox, Leo, Soter, or Shield) or selects Guest Mode to generate a one-time burner wallet.',
                                icon: Store,
                                color: 'text-blue-400',
                                badge: 'Identity',
                            },
                            ...
                            },
                            {
                                ...
                                detail: 'Proof is broadcast via relayer (or DPS if merchant-sponsored). The UI shows a progress indicator while the transaction lands on the Midnight ledger.',
                                icon: PackageCheck,
                                color: 'text-orange-400',
                                badge: 'Settlement',
                            },
            ...
            <section className="space-y-6">
                ...
                <div className="grid gap-5 md:grid-cols-2">
                    <GlassCard className="p-5">
                        ...
                        <p className="text-xs text-gray-400 leading-relaxed">
                            Invoices have a configurable expiry measured in Midnight block heights. Once expired, the on-chain mapping status remains <code className="text-gray-300">0</code> but the Hosted UI will reject payment attempts. Merchants can re-create the invoice with a new hash if needed.
                        </p>
                    </GlassCard>
                    ...
                    <GlassCard className="p-5">
                        ...
                        <p className="text-xs text-gray-400 leading-relaxed">
                            If the merchant backend is offline during settlement, the LumaPay backend queues the webhook and retries with exponential backoff (max 5 attempts over 15 minutes). Merchants can also poll <code className="text-emerald-300/80">GET /api/v1/invoices/:id</code> for idempotency.
                        </p>
                    </GlassCard>
                </div>
            </section>
