            ...
            <div className="w-full max-w-7xl mx-auto pt-12 px-6 relative z-10">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tighter leading-tight text-white">
                        Create <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-300 to-orange-500 drop-shadow-[0_0_15px_rgba(249,115,22,0.3)]">Private Invoice</span>
                    </h1>
                    <p className="text-gray-300 text-xl leading-relaxed max-w-2xl mb-2">
                        Generate a privacy-preserving Private Invoice link to receive payments securely on the Midnight network.
                    </p>
                </motion.div>
