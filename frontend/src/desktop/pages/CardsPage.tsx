    ...
    const highlights = [
        {
            ...
            description: 'Manage active Preprod NIGHT card controls inside one dedicated card wallet.'
        },
        {
            icon: LockKeyhole,
            ...
            >
                ...
                >
                    ...
                    <p className="mt-5 max-w-2xl text-sm leading-relaxed text-white/65 md:text-base">
                        Create a dedicated non-custodial Midnight card wallet, top it up with private funds, and keep spending limits under your main wallet&apos;s approval.
                    </p>
                </motion.div>
