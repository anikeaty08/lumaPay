...
const SHIELD_APP_STORE_URL = 'https://apps.apple.com/us/app/shield-midnight-wallet/id6757471699';
            ...
            >
                <main className="relative z-10 w-full overflow-hidden">
                        ...
                        <div className="relative z-10 w-full px-6 md:px-12 lg:px-24 pt-6 md:pt-36 pb-12">
                            ...
                            >
                                <motion.div variants={fadeInUp} className="mb-16 flex w-full items-center justify-start gap-3 px-1 py-1 md:hidden">
                                    ...
                                    <span className="text-xl font-black tracking-tight text-white">LumaPay</span>
                                </motion.div>
                                ...
                                <div className="relative flex w-full justify-center overflow-visible">
                                    <div className="relative z-20 flex max-w-4xl flex-col items-center text-center md:items-center md:text-center">
                                        ...
                                        >
                                            Private Midnight payments with zero-knowledge proofs.
                                            ...
                                            {shouldShowMobileDashboard ? (
                                                ...
                                                <div className="flex flex-col items-center gap-4">
                                                    ...
                                                    <p className="text-center text-sm text-white/45 max-w-sm leading-relaxed">
                                                        Download Midnight Wallet to use LumaPay on mobile.
                                                    </p>
                                                </div>
                                            )}
                                        </motion.div>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-8 items-start">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-white/50 text-sm leading-relaxed max-w-lg">
                                                    Invoice details are hashed on-chain using Midnight commitment cryptography. Only the hash is public — merchant address, amount, and metadata remain completely private. No one can see what you're being billed for or how much you owe.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <FeatureCard
                                    ...
                                    desc="Payments use Midnight's private transfer function. The sender's identity is never revealed on-chain. No one can trace who paid the invoice."
                                ...
                                <FeatureCard
                                    ...
                                    desc="Pay with Midnight NIGHT on Preprod. Stablecoin support stays behind token availability and contract configuration."
                                    ...
                                    <div className="relative p-8 rounded-2xl bg-[#080808]/80 backdrop-blur-sm border border-cyan-500/15 transition-all duration-700 h-full overflow-hidden">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start justify-between">
                                            ...
                                            <div className="flex gap-6 shrink-0">
                                                {[
                                                    { icon: Binary, label: 'Midnight commitment' },
                                ...
                                <div className="mt-8 mb-4 flex flex-col items-center gap-5 md:gap-4">
                                    ...
                                    <div className="grid w-full max-w-5xl mx-auto items-center gap-3 md:gap-8 group/eco grid-cols-1 md:grid-cols-[1fr_auto_1fr]">
                                        <div className="flex items-center justify-center md:justify-end gap-3">
                                            <img src="/assets/lumapay-mark.png" alt="LumaPay" className="w-10 md:w-16 h-10 md:h-16 object-contain" />
                                    ...
                                    <p className="text-white/30 text-sm md:text-base max-w-[20rem] md:max-w-2xl leading-relaxed font-light text-center">
                                        LumaPay MCP powers seamless private payments inside every tool you already love — from messaging apps to AI assistants.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 relative z-10">
                                        <div className="max-w-lg">
                                            ...
                                            <p className="text-white/35 text-sm leading-relaxed font-light mb-4">
                                                The LumaPay MCP lets AI agents create invoices, verify payments, and settle transactions — all with zero-knowledge privacy.
                                                <br />
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                ...
                                <div className="order-1 lg:order-2 space-y-8">
                                    ...
                                    <p className="text-white/40 text-xs md:text-sm leading-loose max-w-xl font-light">
                                        Take absolute financial privacy wherever you go. LumaPay V1 Mobile is now live, bringing the power of zero-knowledge cryptography to your smartphone.
                                    </p>
                                    ...
                                    <div className="pt-3 pb-2 flex flex-wrap gap-4">
                                        ...
                                        <a
                                            href="https://apps.apple.com/us/app/shield-midnight-wallet/id6757471699"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="group inline-flex items-center gap-3 bg-[#060606] border border-white/[0.08] hover:border-orange-500/40 hover:bg-[#111] transition-all rounded-xl px-5 py-2.5 shadow-2xl overflow-hidden relative cursor-pointer"
                                        >
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                                        {[
                                            {
                                                icon: Shield,
                                                title: 'Midnight Wallet Beta',
                                                desc: 'Integrated with Midnight Wallet for secure key management and private transactions.',
                    ...
                    <section className="py-20 lg:py-24 px-6 md:px-12 lg:px-24 relative overflow-hidden">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                                ...
                                {[
                                    { step: '01', title: 'Create Invoice', desc: 'Construct a private invoice. Details are hashed using Midnight commitment, ensuring absolute data integrity without public exposure.', icon: FileText, delay: 0.1 },
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <h2 className="text-xl md:text-2xl lg:text-3xl font-black tracking-[-0.03em] leading-tight">
                                        Powered by{' '}
                                        <span className="text-orange-500 drop-shadow-[0_0_30px_rgba(249,115,22,0.4)]">Midnight</span>
                                    </h2>
                                    <p className="text-white/40 font-light leading-relaxed text-sm md:text-base">
                                        Midnight is a <strong className="text-white font-semibold">Layer-1 blockchain</strong> purpose-built for zero-knowledge applications. Unlike Ethereum or Solana where privacy is an afterthought, Midnight makes ZK-proofs a native, first-class feature.
                                    </p>
                    ...
                    <section className="py-20 lg:py-24 px-6 md:px-12 lg:px-24 relative overflow-hidden">
                        ...
                        >
                            <motion.div variants={fadeInUp} className="text-center mb-16">
                                <span className="font-mono-syne text-[10px] uppercase tracking-[0.3em] text-white/35 font-semibold">Why LumaPay</span>
                                <h2 className="text-xl md:text-2xl lg:text-3xl font-black tracking-[-0.03em] mt-4">
                                    Privacy is{' '}
                                ...
                                <p className="text-white/35 text-sm md:text-base mt-4 max-w-xl mx-auto font-light">
                                    See how LumaPay fundamentally differs from traditional blockchain payments.
                                </p>
                            </motion.div>
                            ...
                            <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-6 items-stretch">
                                ...
                                <div className="relative p-10 rounded-3xl bg-[#080808]/80 backdrop-blur-xl border border-white/5 overflow-hidden group hover:border-orange-500/20 transition-all duration-700">
                                    ...
                                    <div className="flex items-center gap-4 mb-10 relative z-10">
                                        ...
                                        <h3 className="text-sm font-bold text-white/80 tracking-[0.2em] uppercase">LumaPay Protocol</h3>
                                    </div>
                                ...
                                <div className="flex flex-col items-center gap-4 opacity-40 hover:opacity-80 transition-opacity duration-700">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-mono-syne text-[9px] tracking-[0.5em] uppercase text-white/60">
                                            SECURED BY NIGHT ZK-PROOF SYSTEMS
                                        </span>
                                    </div>
                                </div>
                            </div>
