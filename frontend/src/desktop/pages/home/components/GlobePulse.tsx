      ...
      globe = createGlobe(canvas, {
        ...
        onRender: (state: Record<string, number>) => {
          ...
          currentOffset.current = {
            phi: currentOffset.current.phi + (targetOffset.current.phi - currentOffset.current.phi) * 0.12,
            theta: currentOffset.current.theta + (targetOffset.current.theta - currentOffset.current.theta) * 0.12,
          }
          state.phi = phi + phiOffsetRef.current + currentOffset.current.phi
          state.theta = 0.2 + thetaOffsetRef.current + currentOffset.current.theta
        },
      })
