            ...
            <div className="w-full pt-32 relative z-10 pb-24 container-custom">
                ...
                >
                    ...
                    <p className="text-gray-300 text-xl leading-relaxed max-w-2xl mb-8">
                        LumaPay leverages Zero-Knowledge Proofs (ZKP) to ensure your financial data remains confidential.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <GlassCard className="p-10 min-h-[400px] flex flex-col justify-between relative overflow-hidden group hover:bg-white/5 transition-all duration-500 border border-white/5 hover:border-white/10">
                        ...
                        <p className="text-gray-400 mb-5 leading-relaxed">
                            In early versions of LumaPay, every payment was anchored by a <strong>public on-chain mapping</strong>. That design worked, but it had a fundamental privacy flaw: anyone scanning the blockchain could observe the link between a payment secret and the settled amount.
                        </p>
                            ...
                            <div className="flex-1 bg-black/40 border border-white/5 rounded-2xl overflow-hidden relative group/legacy">
                                ...
                                <div className="px-4 py-3 bg-white/5 border-b border-white/5 flex items-center justify-between relative z-10">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] text-gray-400 font-mono tracking-wider">legacy.midnight</span>
                                    </div>
                            ...
                            <div className="flex-1 bg-black/40 border border-white/5 rounded-2xl overflow-hidden relative group/v27 shadow-[0_0_20px_rgba(249,115,22,0.05)]">
                                ...
                                <div className="px-4 py-3 bg-white/5 border-b border-orange-500/20 flex items-center justify-between relative z-10">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] text-orange-200 font-mono tracking-wider">v27_private.midnight</span>
                                    </div>
                        ...
                        <div className="mt-2 mb-4 relative p-5 bg-gradient-to-br from-white/5 to-transparent rounded-2xl border border-white/5 overflow-hidden group">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <p className="text-[11px] text-gray-500 leading-relaxed"><code className="text-orange-300/80 bg-orange-500/10 px-1 rounded font-mono">pay_invoice</code> outputs a <code className="text-orange-300/80 bg-orange-500/10 px-1 rounded font-mono">PayerReceipt</code> natively encrypted via Midnight's record model.</p>
                                </div>
                        ...
                        <p className="text-sm text-gray-500 leading-relaxed">
                            The removal of the public mapping is not a minor refactor — it is the foundational privacy guarantee that makes LumaPay different. Without a public mapping, there is no enumerable on-chain data structure that reveals who paid whom, or how much.
                        </p>
                    </GlassCard>
                        ...
                        <div className="mt-8 pt-6 border-t border-white/5 grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                                        The settlement logic creates standardized receipts for both <span className="text-white">Midnight NIGHT</span> and <span className="text-white">USDCx</span>, preserving the same privacy guarantees.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                    ...
                    <GlassCard className="p-10 min-h-[400px] flex flex-col justify-between relative overflow-hidden group hover:bg-white/5 transition-all duration-500 border border-white/5 hover:border-white/10">
                        ...
                        <div className="bg-black/40 rounded-xl p-4 border border-white/5 font-mono text-xs space-y-3 mb-4">
                            <div className="flex justify-between pb-2 border-b border-white/5">
                                <span className="text-gray-500 uppercase tracking-widest">Contract: zk_pay_proofs_privacy_v29.midnight</span>
                            </div>
                        ...
                        <div className="space-y-2 mb-4">
                            ...
                            <div className="flex items-start gap-3 bg-white/3 rounded-lg p-3 border border-white/5">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 text-[11px] leading-relaxed">Anyone with the payment_secret can prove payment by re-deriving receipt_hash and matching it against the on-chain PayerReceipt record — without trusting LumaPay at all.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-black/40 rounded-xl p-3 border border-white/5">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className="text-[10px] text-gray-500 font-mono">credits.midnight</span>
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            <div className="bg-black/40 rounded-xl p-5 border border-purple-500/20 flex flex-col gap-3">
                                ...
                                <p className="text-sm text-gray-400 leading-relaxed">
                                    A fresh Midnight private key is generated entirely on your device. It is <strong className="text-white">never</strong> transmitted in plaintext.
                                </p>
                            </div>
                            <div className="bg-black/40 rounded-xl p-5 border border-purple-500/20 flex flex-col gap-3">
                            ...
                            <div className="bg-black/40 rounded-xl p-5 border border-purple-500/20 flex flex-col gap-3">
                                ...
                                <p className="text-sm text-gray-400 leading-relaxed">
                                    You can optionally back up the encrypted key as an on-chain Midnight record in the <code className="text-purple-300 bg-white/5 px-1 rounded">zk_pay_proofs_privacy_wallet</code> program. Only you can decrypt it.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-purple-500/5 border border-purple-500/20 rounded-xl p-5 flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div className="flex-1">
                                ...
                                <ul className="space-y-1 text-xs text-gray-400">
                                    ...
                                    <li className="flex items-center gap-2"><span className="text-red-400">✗</span> Your LumaPay password in any form</li>
                    ...
                    <GlassCard className="p-10 flex flex-col relative overflow-hidden group hover:bg-white/5 transition-all duration-500 border border-white/5 hover:border-white/10 md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-8 leading-relaxed max-w-3xl">
                            LumaPay protects sensitive data with two independent, orthogonal encryption layers. Even if one layer is compromised, the other keeps your data safe. This is not security theater — it is defense-in-depth.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div className="relative bg-black/40 rounded-xl p-6 border border-yellow-500/20 overflow-hidden">
                                ...
                                <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                                    Your LumaPay password never leaves your browser. It is used locally to derive an <code className="text-yellow-400 bg-white/5 px-1 rounded">AES-256-GCM</code> encryption key via <code className="text-yellow-400 bg-white/5 px-1 rounded">PBKDF2</code>.
                                </p>
                                ...
                                <ul className="mt-4 space-y-1 text-xs text-gray-500">
                                    ...
                                    <li className="flex items-center gap-2"><span className="text-green-400">✓</span> Encrypted key stored in DB or as an Midnight on-chain record</li>
