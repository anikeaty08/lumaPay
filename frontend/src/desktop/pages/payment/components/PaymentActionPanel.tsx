                            ...
                            statusElement={
                                giftCardPayerAddressInvalid ? (
                                    <>
                                        ...
                                        <span className="text-[10px] text-red-100/50 italic">Invalid Midnight address format</span>
                                    </>
                                ) : (
                                    <>
                                        <div className="h-1 w-1 rounded-full bg-white/50" />
                                        <span className="text-[10px] text-white/50 italic">Valid Midnight address</span>
                                    </>
                                )
                            }
                        />
