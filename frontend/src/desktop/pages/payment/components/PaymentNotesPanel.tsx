...
import { COMPACT_PAYMENT_NOTE_MAX_BYTES } from '../../../../shared/utils/core/compactInputLimits';
                    ...
                    <div className="rounded-2xl bg-black/30 p-4 space-y-4">
                        <div>
                            ...
                            <p className={`mt-2 text-[11px] ${payerNoteTooLong ? 'text-red-400' : 'text-gray-500'}`}>
                                Payer note uses one Compact field: {payerNoteBytes}/{COMPACT_PAYMENT_NOTE_MAX_BYTES} bytes.
                            </p>
                        </div>
