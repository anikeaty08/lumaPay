        ...
        return (
            <div className="min-h-screen bg-black text-white px-4 py-12">
                <div className="mx-auto max-w-xl rounded-3xl border border-white/10 bg-white/[0.04] p-8 text-center shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                    <p className="text-sm text-white/65">Checking your encrypted LumaPay profile and on-chain backup records...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-black text-white px-4 py-12">
            <div className="mx-auto max-w-xl">
                <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                    <div className="mb-6">
                        <p className="text-xs uppercase tracking-[0.28em] text-cyan-300/70">LumaPay Telegram Link</p>
                        <h1 className="mt-3 text-3xl font-black">Verify your merchant wallet</h1>
                        <p className="mt-3 text-sm leading-6 text-white/60">
                            This one-time browser step follows the same LumaPay security flow as the rest of the app: connect your wallet, unlock or create your LumaPay password, then sign a short link message so Telegram can show merchant invoice updates.
                        </p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-4">
                            <div className="rounded-2xl border border-emerald-400/30 bg-emerald-500/10 p-6 text-sm text-emerald-50">
                                Your wallet is now linked to LumaPay Telegram. {redirecting
                        ...
                        <div className="space-y-5">
                            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 text-sm text-white/70">
                                ...
                                <p className="mt-3 text-white/45">
                                    Message action: <span className="font-mono text-white/70">lumapay_telegram_link_v1</span>
                                </p>
                            </div>
                            ...
                            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 text-sm text-white/60">
                                ...
                                <p className="mt-2 break-all font-mono text-xs text-cyan-200/80">
                                    {address || 'Connect your Midnight wallet to continue.'}
                                </p>
                            </div>
