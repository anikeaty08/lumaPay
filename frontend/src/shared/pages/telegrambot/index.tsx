...
/* ── Data ─────────────────────────────────────────────────── */
const BOT_USERNAME = '@lumapay_private_bot';
const BOT_LINK = 'https://t.me/lumapay_private_bot';
...
const sections: TBSection[] = [
        ...
        content: (
            <div className="space-y-6">
                ...
                <Callout title="Get Started" tone="blue">
                    Find the bot at <span className="font-mono text-orange-300">@lumapay_private_bot</span> or open{' '}
                    <a href={BOT_LINK} target="_blank" rel="noreferrer" className="text-orange-300 underline">t.me/lumapay_private_bot</a>.
    ...
    },
    {
        ...
        summary: 'Link your Midnight wallet to Telegram via a secure browser flow with signature verification. One-time setup, persistent across sessions.',
        content: (
            <div className="space-y-8">
                ...
                <div className="relative">
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            { step: '03', icon: KeyRound, title: 'Password Gate', body: 'User connects their Midnight wallet and creates/unlocks their LumaPay password before linking can complete.' },
                            { step: '04', icon: Fingerprint, title: 'Signature Verification', body: 'User signs a message containing Telegram session metadata. Backend verifies the Midnight signature and marks the session consumed.' },
                ...
                <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] overflow-hidden">
                    ...
                    <div className="px-5 py-4">
                        <p className="text-sm font-mono text-gray-300 leading-relaxed">Link your wallet to the LumaPay Telegram Bot</p>
                ...
                <GlassCard className="p-6">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        {[
                            ...
                            'Explorer links open the Midnight testnet transaction directly from Telegram.',
                        ].map((item) => (
            ...
            <div className="space-y-6">
                <div className="space-y-6">
                    {[
                        ...
                        { title: '2. NIGHT Amount', body: 'Set the NIGHT amount for the payment. Stable-token and cross-token choices are not exposed on Preprod.' },
        ...
        content: (
            <div className="space-y-6">
                <p className="text-base leading-relaxed text-gray-300">
                    LumaPay keeps decryption, password use, and signing in the browser so the security model stays aligned with the rest of the app. Telegram handles the workflow layer (linking, creation, monitoring, alerts) but never sees private keys, passwords, or decrypted records.
                </p>
                ...
                <motion.div variants={fadeInUp} className="border-b border-white/[0.05]">
                    <div className="mx-auto max-w-7xl px-6 pt-12 pb-8 text-center">
                        ...
                        <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-white">
                            LumaPay <span className="bg-gradient-to-r from-orange-400 to-orange-300 bg-clip-text text-transparent">Telegram Bot</span>
                        </h1>
