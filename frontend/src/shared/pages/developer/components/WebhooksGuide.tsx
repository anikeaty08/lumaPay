        ...
        <div className="space-y-8">
            <GlassCard className="p-8 md:p-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed mb-8">
                    The demo merchant backend verifies the `x-lumapay-signature` header against the raw request body and only fulfills when the webhook event is valid. This is the cleanest production path because settlement reaches your server even if the customer closes the browser after paying.
                </p>
