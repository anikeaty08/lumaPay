    ...
    return (
        <div className="space-y-8">
            <GlassCard className="p-8 md:p-10">
                ...
                <h2 className="text-3xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-300 to-orange-500 drop-shadow-[0_0_15px_rgba(249,115,22,0.3)] mt-3 mb-2">What LumaPay Checkout Actually Does</h2>
...
LumaPay backend -> signed webhook to merchant
