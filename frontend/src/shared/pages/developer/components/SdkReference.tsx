...
export const SdkReference: React.FC = () => {
  ...
  "invoices": [
    ...
    const nodeInit = [
        ...
        '',
        'const client = new LumaPay({',
        '  secretKey: process.env.LUMAPAY_SK,',
    ...
    const createSession = [
        ...
        "  lumapay_invoice_name: 'basic-usdcx',",
        ...
        <div className="space-y-8">
            <GlassCard className="p-8 md:p-10">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-gradient-gold drop-shadow-gold">What is lumapay.json?</h2>
                </div>
                ...
                <DeveloperCodeBlock title="Example lumapay.json" code={lumapayExample} language="json" />
            </GlassCard>
            ...
            <GlassCard className="p-8 md:p-10">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-gradient-gold drop-shadow-gold">Node SDK: @lumapay/node</h2>
                </div>
            ...
            <GlassCard className="p-8 md:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-xs text-gray-500 leading-relaxed">
                            Always verify the <code className="text-orange-300 font-mono">lumapay-signature</code> using our HMAC-SHA256 helper to prevent spoofing.
                        </p>
                    </div>
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a 
                                    href="https://github.com/geekofdhruv/LumaPay"
                                    target="_blank"
