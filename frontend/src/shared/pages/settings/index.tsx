...
export default function SettingsPage() {
    ...
    const [estimationEnabled, setEstimationEnabled] = useState(() => {
        try { return localStorage.getItem('lumapay_fee_estimation') !== 'false'; }
        catch { return true; }
    });
    const toggleEstimation = useCallback(() => {
        const next = !estimationEnabled;
        setEstimationEnabled(next);
        try { localStorage.setItem('lumapay_fee_estimation', String(next)); }
        catch { /* noop */ }
    }, [estimationEnabled]);
    ...
    return (
        <div className="page-container relative min-h-screen">
            ...
            {/* Midnight Globe background */}
            <div className="absolute top-[-150px] left-1/2 -translate-x-1/2 w-screen h-[800px] z-0 pointer-events-none flex justify-center overflow-hidden">
                <img src="/assets/lumapay-network-hero.png" alt="Midnight privacy network"
            ...
            <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit"
                ...
                <div className="flex flex-col items-center justify-center text-center mb-12">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed max-w-xs">Manage your LumaPay preferences</p>
                </div>
                        ...
                        <div className="flex items-center gap-4">
                            <div>
                                ...
                                <div className="text-white/30 text-xs mt-0.5">
                                    {connected ? 'Midnight wallet connected' : 'Connect a wallet to access all features'}
                                </div>
                            </div>
                        </div>
                        {connected && (
                    ...
                    <div className="px-6 py-5 space-y-3">
                        {telegramLoading ? (
                            ...
                            <div className="py-3">
                                ...
                                <div className="text-white/25 text-xs">Link your Telegram account via the LumaBot to receive payment alerts and manage invoices from Telegram.</div>
                            </div>
                        ) : (
                            <>
                ...
                <GlassCard variant="default" hoverEffect={false} className="p-0 overflow-hidden">
                    ...
                    <ToggleRow
                        ...
                        description="Automatically adjust fee estimates based on live Midnight network data."
                        ...
                        statusText={estimationEnabled ? (
                            <div className="space-y-2.5">
                                ...
                                <p className="text-white/40 text-xs leading-relaxed">
                                    LumaPay dynamically calculates optimal transaction fees by scanning current Midnight network congestion. A safety buffer is applied to prevent transaction execution drop-outs; unused gas credits are automatically refunded.
                                </p>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <p className="text-white/40 text-xs leading-relaxed">
                                    All transactions will use a pre-configured base fee. Note that during periods of high Midnight network congestion, static fees may result in transaction delays or execution failures.
                                </p>
                            </div>
                        )}
                    />
                    ...
                    <ToggleRow
                        ...
                        statusText={notifyOnSettled ? (
                            <div className="space-y-2.5">
                                ...
                                <p className="text-white/40 text-xs leading-relaxed">
                                    You will receive instant browser alerts when incoming invoice payments are fully confirmed and settled on the Midnight blockchain.
                                </p>
                            </div>
                        ) : (
                            <div className="space-y-1.5">
                                ...
                                <p className="text-white/40 text-xs leading-relaxed">
                                    Settlement notifications are turned off. You will need to manually monitor the payment dashboard or search the transaction hash on the Midnight explorer to verify status updates.
                                </p>
                            </div>
                        )}
                    />
                ...
                <GlassCard variant="default" hoverEffect={false} className="p-0 overflow-hidden">
                    ...
                    <button onClick={() => navigate('/support-feedback')}
                        ...
                        <div className="ml-14 px-3 py-2.5 rounded-lg bg-white/[0.03] border border-white/[0.06] text-white/40 text-xs leading-relaxed space-y-1">
                            <div className="text-white/60 font-medium">LumaPay Support Center</div>
