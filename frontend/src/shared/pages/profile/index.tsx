...
import { PROGRAM_ID } from '../../utils/midnight/midnightUtils';
    ...
    return (
        <div className="page-container relative min-h-screen">
                    ...
                    <div className="space-y-3">
                        <div className="rounded-2xl border border-red-500/20 bg-red-500/10 px-4 py-3 text-red-100/90">
                            ...
                            <p className="mt-2 leading-relaxed">
                                This submits a cancellation to Invoice Core. If the invoice has already passed its expiry, LumaPay records it as expired instead.
                            </p>
                        </div>
                        <p className="leading-relaxed text-gray-300">
                            This only works for an <span className="font-semibold text-white">open standard invoice</span> with no settlement.
                        </p>
                        {actions.invoicePendingDeletion?.walletType === 1 ? (
                            <p className="leading-relaxed text-gray-300">
                                This is a <span className="font-semibold text-white">burner-owned invoice</span>. LumaPay will use the unlocked burner wallet to submit the on-chain deletion first, then clear the database entry.
                            </p>
                        ) : (
                            <p className="leading-relaxed text-gray-300">
                                LumaPay will request approval from your connected main wallet, wait for on-chain confirmation, and then remove the database entry.
                            </p>
                        )}
                    </div>
                }
            ...
            <PaymentHistoryModal
                ...
                onViewTx={(txId) => void navigator.clipboard.writeText(txId)}
            />
