...
import type { PendingToolCall } from '../../../../../types/lumabot';
import { getPendingToolPrompt } from '../lib/utils';

interface LumaBotComposerProps {
    connected: boolean;
...
export const LumaBotComposer: React.FC<LumaBotComposerProps> = ({
    connected,
    pendingToolCall,
    input,
    isThinking,
            ...
            >
                <div className="flex items-center gap-2 rounded-2xl border border-white/10 bg-black/40 px-3 py-2.5 shadow-inner transition-all focus-within:border-orange-500/40 focus-within:bg-black/60">
                    <input
                        ...
                        placeholder="Ask anything in plain language. LumaBot will pick the tool, collect details, and trigger the browser flow."
