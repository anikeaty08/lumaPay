...
import type { DashboardChatbotProps } from '../../../../../types/lumabot';
import { TOOL_PILLS } from '../lib/constants';
import { LumaBotComposer } from './LumaBotComposer';
import { LumaBotHeader } from './LumaBotHeader';
import { LumaBotMessages } from './LumaBotMessages';
import { LumaBotStatusBar } from './LumaBotStatusBar';
import { useBurnerBalanceContext } from '../hooks/useBurnerBalanceContext';
import { useChatHistory } from '../hooks/useChatHistory';
import { useLumaBotController } from '../hooks/useLumaBotController';
...
export const DashboardChatbot: React.FC<DashboardChatbotProps> = (props) => {
    ...
    const { isThinking, actionStatus, pendingToolCall, sendMessage } = useLumaBotController({
        ...props,
        connected,
        address,
        executeTransaction,
