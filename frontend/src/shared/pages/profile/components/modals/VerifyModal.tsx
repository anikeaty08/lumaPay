                                            ...
                                            {matchingReceipts.map((receipt, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <span className="font-bold text-white text-sm whitespace-nowrap ml-3">
                                                        {receipt.amount / 1_000_000} <span className="text-xs text-gray-400 font-normal">{receipt.tokenType === 0 ? 'NIGHT' : receipt.tokenType === 1 ? 'USDCx' : 'USAD'}</span>
                                                    </span>
                                                </div>
                                            ))}
                                        </div>
                                ...
                                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                                    ...
                                    <div className="space-y-1 text-sm">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-white font-mono">{verifiedRecord.amount} {verifiedRecord.tokenType === 0 ? 'NIGHT' : verifiedRecord.tokenType === 1 ? 'USDCx' : 'USAD'}</span>
                                        </div>
