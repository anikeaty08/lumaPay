...
export const ReportConfigModal: React.FC<ReportConfigModalProps> = ({
    ...
    useEffect(() => {
        ...
        const saved = localStorage.getItem(`lumapay_report_prefs_${reportType}`);
        if (saved) {
            try {
    ...
    const handleGenerate = async () => {
        if (savePreferences) {
            localStorage.setItem(`lumapay_report_prefs_${reportType}`, JSON.stringify(options));
        }
                        ...
                        <>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        placeholder={`LumaPay_${reportType === 'audit' ? 'Audit' : 'Credit'}_Report_...`}
                                        value={filename}
