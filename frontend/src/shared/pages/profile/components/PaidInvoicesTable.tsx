                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        {totalNIGHT > 0 && (
                                            <span className="font-bold text-white text-sm">
                                                {formatTokenAmount(totalNIGHT)}
                                                <span className="ml-1 text-[10px] uppercase tracking-[0.18em] text-gray-500">NIGHT</span>
                                            </span>
                                        )}
                                        {totalUSDCx > 0 && (
                                            <span className="font-bold text-white text-sm">
                                        ...
                                        {totalNIGHT === 0 && totalUSDCx === 0 && totalUSAD === 0 && (
                                ...
                                <td className="py-4 px-6 text-center">
                                    {receipts.length === 1 && receipts[0].transactionId ? (
                                        <div className="flex justify-center items-center gap-2 group/tx">
                                            <a 
                                                href={`https://api-preprod.1am.xyz/api/v4/graphql#transaction-${receipts[0].transactionId}`}
                                                target="_blank"
