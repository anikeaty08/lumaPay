...
interface StatsCardsProps {
    merchantStats: {
        ...
        averageInvoiceAmountNIGHT: string;
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-12 gap-4">
                    ...
                    {volumeLoading ? (
                        ...
                        <div className="space-y-1">
                            <div className="flex items-baseline gap-2">
                                <span className="text-2xl font-bold text-white tracking-tighter">{merchantStats.mainNIGHT}</span>
                                <span className="text-[10px] font-normal text-gray-500 uppercase">NIGHT</span>
                            </div>
                        </div>
                    )}
                </GlassCard>
                ...
                <GlassCard className="p-6 flex flex-col justify-center group hover:border-white/20 relative overflow-hidden xl:col-span-3">
                    ...
                    {volumeLoading ? (
                        ...
                        <div className="space-y-1">
                            <div className="flex items-baseline gap-2">
                                <span className="text-2xl font-bold text-white tracking-tighter">{merchantStats.burnerNIGHT}</span>
                                <span className="text-[10px] font-normal text-gray-500 uppercase">NIGHT</span>
                            </div>
                        </div>
                    )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                <GlassCard className="p-6 flex flex-col justify-center group hover:border-white/20">
                    ...
                    {invoiceLoading ? (
                        ...
                        <div className="space-y-2">
                            <div className="flex items-baseline gap-2">
                                <span className="text-2xl font-bold text-white tracking-tighter">{merchantStats.averageInvoiceAmountNIGHT}</span>
                                <span className="text-[10px] font-normal text-gray-500 uppercase">NIGHT</span>
                            </div>
                            <p className="text-xs text-gray-500">Average amount for non-donation NIGHT invoices</p>
                        </div>
                    )}
                </GlassCard>
