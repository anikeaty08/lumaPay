            ...
            >
                ...
                <div className="mb-4 rounded-xl border border-blue-500/20 bg-blue-500/10 px-4 py-3 text-left">
                    <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-blue-300 mb-1">
                        Sponsored By LumaPay
                    </p>
                    <p className="text-xs leading-relaxed text-white/75">
                        The sweep is still authorized from your browser, but LumaPay&apos;s relayer can sponsor the execution fee so you do not need extra gas just to move burner funds out.
                    </p>
                </div>
                ...
                <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        {!isScanningBalances && privateBalances.NIGHT === -1 && (
                ...
                {sweepSuccess && (
                    <div className="mb-4 p-3 bg-green-500/10 border border-green-500/20 rounded-lg text-green-400 text-sm text-center font-bold">
                        {sweepSuccess}
                        {sweepTxId && (
                            <a href={`https://api-preprod.1am.xyz/api/v4/graphql#transaction-${sweepTxId}`}
