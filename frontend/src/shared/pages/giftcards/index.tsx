            ...
            >
                ...
                <div className="max-w-xl rounded-2xl border border-orange-400/20 bg-orange-500/10 px-5 py-4 text-left">
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">
                        Redeeming a gift card and paying directly from a gift card use LumaPay&apos;s relayer sponsorship flow. Proofs stay local, while LumaPay can cover the network fee for supported redeem and gift-card checkout actions.
                    </p>
                </div>
            </motion.div>
