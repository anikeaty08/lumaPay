export const FEE_PREFERENCE_STORAGE_KEY = 'lumapay_fee_mode';
export const FEE_PREFERENCE_EVENT = 'lumapay-fee-preference-change';
export const FIXED_FEE_MICRONIGHT = 20_000;
