...
export const COMPACT_FIELD_MAX_BYTES = 31;
export const COMPACT_SAFE_CHUNK_BYTES = 15;

export const COMPACT_MEMO_MAX_BYTES = COMPACT_FIELD_MAX_BYTES;
export const COMPACT_INVOICE_TITLE_MAX_BYTES = COMPACT_FIELD_MAX_BYTES;
export const COMPACT_PAYMENT_NOTE_MAX_BYTES = COMPACT_FIELD_MAX_BYTES;
export const GIFT_CARD_RECORD_LABEL_MAX_BYTES = COMPACT_FIELD_MAX_BYTES;
export const COMPACT_PASSWORD_BACKUP_MAX_BYTES = COMPACT_SAFE_CHUNK_BYTES;
...
export function getMaxEncryptedPlaintextBytes(chunkCount: number, chunkSize: number = COMPACT_SAFE_CHUNK_BYTES) {
