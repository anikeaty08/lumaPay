...
export const ProtectedRoute: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const isLocked = needsConnect;
    const lockReason = needsConnect ? 'connect' as const : 'ready' as const;
                    ...
                    {needsConnect && (
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-white/50 mb-6 text-sm leading-relaxed">
                                Connect a compatible Midnight wallet to use this secured page, or dismiss to browse.
                            </p>
                            ...
                            <div className="mt-4 w-full rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-left">
                                <p className="text-xs font-semibold text-white">Public proof verification</p>
                                <p className="mt-1 text-xs text-white/50">
                                    Auditors can verify a disclosed proof bundle without signing in or gaining merchant access.
                                </p>
                                <Link
                                    to="/audit/verify"
