...
const QUICK_PROMPTS_DOCS = [
    ...
    'What tokens does LumaPay support?',
...
const QUICK_PROMPTS_DEV = [
    ...
    'Show me how to initialize LumaPay in my backend.',
    'What happens if my webhook fails?',
    'How do I verify a payment hash on-chain?',
];

const INITIAL_MSG_DOCS = 'Hello! I am LumaBot, your Documentation Assistant. I can help you navigate the LumaPay technical docs, explain APIs, SDKs, and Smart Contracts. What are you looking for?';

const INITIAL_MSG_DEV = 'Hello! I am LumaBot, your Developer Portal Assistant. I can help you with Secret Keys, Webhook configuration, and integrating the SDK into your backend. What are you building today?';
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2">
                                                <span className="text-sm font-semibold text-white">LumaBot</span>
                                                <Sparkles size={14} className="text-orange-300" />
                                            </div>
                                            <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                                                Your intelligent copilot for LumaPay {mode === 'docs' ? 'documentation' : 'integrations'}.
                                            </p>
                                        </div>
                                    </div>
