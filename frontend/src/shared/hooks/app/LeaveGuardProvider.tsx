...
const defaultGuard: GuardState = {
    active: false,
    title: 'Wait For Sync',
    message: 'A transaction is still syncing. Leaving now may interrupt the flow before LumaPay finishes confirming the result.',
    confirmLabel: 'Leave Anyway',
    cancelLabel: 'Stay'
};

const NATIVE_UNLOAD_WARNING = 'A LumaPay transaction is still in progress. Leaving now may interrupt syncing.';
