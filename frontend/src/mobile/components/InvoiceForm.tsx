...
import { getUtf8ByteLength, COMPACT_INVOICE_TITLE_MAX_BYTES, COMPACT_MEMO_MAX_BYTES } from '../../shared/utils/core/compactInputLimits';
                    ...
                    {!publicKey ? (
                        ...
                        >
                            {loading ? (
                                ...
                                invoiceType === 'standard' ? 'Generate Private Invoice Link' :
